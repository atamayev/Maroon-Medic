...
export default function ConfirmedBookingModal (props: Props) {
	const { message, appointmentInformation, serviceMinutes, showModal } = props
					...
					<div className="bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
						<div className="sm:flex sm:items-start">
							<div className="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left">
								<h3 className="text-lg leading-6 font-medium text-gray-900" id="modal-title">Appointment Confirmation</h3>
								<div className="mt-2">
									<div className="bg-yellow-100 p-4 rounded border border-brown-400">
										...
										<div className="block text-brown-800 mb-1">
											...
											{moment(appointmentInformation.selectedTime, "HH:mm")
												.add(serviceMinutes, "minute").format("h:mm A")}
										</div>
										<div className="block text-brown-800 mb-1">
											<strong className="font-bold">
												Price:
