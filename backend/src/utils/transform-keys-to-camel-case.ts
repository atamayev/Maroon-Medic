...
const toCamelCase = (str: string) => _.camelCase(str)

// Convert snake_case keys to camelCase keys for an object
export const transformKeysToCamelCase = (obj: { [key: string]: any }) => {
	return _.mapKeys(obj, (value, key) => toCamelCase(key))
}

export const transformArrayOfObjectsToCamelCase = (array: Array<{ [key: string]: any }>) => {
