...
export default new class FetchDoctorAccountData{
    ...
    async FetchDoctorServices (DoctorID){
        ...
        const sql = `SELECT ${table_name2}.Category_name, ${table_name2}.Service_name, ${table_name1}.service_mapping_ID, ${table_name1}.Service_and_Category_ID, ${table_name1}.Service_time, ${table_name1}.Service_price FROM ${table_name2} JOIN ${table_name1} ON ${table_name2}.service_and_category_listID = ${table_name1}.Service_and_Category_ID WHERE ${table_name1}.Doctor_ID = ?`;
        const values = [DoctorID];
        await useDB(functionName, DB_name, table_name1);
    ...
    async FetchDoctorAddressData (DoctorID){
        ...
        const DB_name = 'DoctorDB';
        const sql = `SELECT ${table_name2}.addresses_ID, ${table_name2}.address_priority, ${table_name2}.address_title, ${table_name2}.address_line_1, ${table_name2}.address_line_2, ${table_name2}.city, ${table_name2}.state, ${table_name2}.zip, ${table_name2}.country, ${table_name1}.phone_priority, ${table_name1}.phone FROM ${table_name2}, ${table_name1} WHERE ${table_name2}.addresses_ID = ${table_name1}.address_ID AND ${table_name2}.Doctor_ID = ?`;
